...
libsbmemlib.a:  ./src/sbmemlib.c
	gcc -ggdb3 -Wall -c ./src/sbmemlib.c -lrt -lm
	ar -cvq libsbmemlib.a sbmemlib.o
	ranlib libsbmemlib.a

app: ./src/app.c
	gcc -ggdb3 -Wall -o app ./src/app.c -L. -lsbmemlib -lrt -lm

create_memory_sb: ./src/create_memory_sb.c
	gcc -ggdb3 -Wall -o create_memory_sb ./src/create_memory_sb.c -L. -lsbmemlib -lrt -lm

destroy_memory_sb: ./src/destroy_memory_sb.c
	gcc -ggdb3 -Wall -o destroy_memory_sb ./src/destroy_memory_sb.c -L. -lsbmemlib -lrt -lm
